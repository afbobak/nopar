...
exports.start = function (app, options) {
  ...
  app.use('/apple-touch-icon-precomposed.png',
    express.static(path.join(PUBLIC_PATH, "img", "favicon.png")));
  app.use('/apple-touch-icon.png',
    express.static(path.join(PUBLIC_PATH, "img", "favicon.png")));
  app.use('/favicon.ico',
    express.static(path.join(PUBLIC_PATH, "img", "favicon.ico")));
  ...
  if ("development" === env) {
    ...
    app.use(function (err, req, res, next) {
      ...
      winston.error(msg === Object.prototype.toString.call(err) ?
        util.inspect(err) : msg);
      next(err);
    });
  }
