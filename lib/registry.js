...
exports.getDependents = function (pkg) {
  ...
  exports.iteratePackages(function (name, candidate) {
    ...
    if (latest.dependencies && latest.dependencies[packagename]) {
      ...
      try {
        deps[candidate.name].outdated =
          semver.gtr(version, latest.dependencies[packagename]);
      } catch (e) {
        winston.debug("Failed to compare version for " + packagename, e);
      }
    ...
    if (latest.devDependencies && latest.devDependencies[packagename]) {
      ...
      try {
        deps[candidate.name].outdated =
          semver.gtr(version, latest.devDependencies[packagename]);
      } catch (e) {
        winston.debug("Failed to compare version for " + packagename, e);
      }
      deps["_counts"].dev++;
    ...
    if (latest.peerDependencies && latest.peerDependencies[packagename]) {
      ...
      try {
        deps[candidate.name].outdated =
          semver.gtr(version, latest.peerDependencies[packagename]);
      } catch (e) {
        winston.debug("Failed to compare version for " + packagename, e);
      }
      deps["_counts"].peer++;
