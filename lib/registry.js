...
exports.getPackage = function (pkgName, version, settings) {
  ...
  try {
    pkgMeta.versions.sort(semver.compare);
    pkgMeta["_highestVersion"] = pkgMeta.versions[pkgMeta.versions.length - 1];
  } catch (e) {
    pkgMeta["_highestVersion"] = pkgMeta["dist-tags"].latest;
  }
